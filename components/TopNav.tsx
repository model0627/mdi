...
export default function TopNav({ activeView, onViewChange }: TopNavProps) {
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between px-3 sm:px-5 py-2" style={{ minHeight: 48 }}>
        {/* Left: Brand + Live */}
      ...
      {/* Row 2: View Tabs — separate row for reliable horizontal scroll */}
      <nav
        className="flex items-center gap-1 px-3 sm:px-5 pb-2 overflow-x-auto scrollbar-hide"
